...
class FormulaPage extends StatefulWidget {
  ...
  @override
  State<FormulaPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<FormulaPage> {
  double?  m  ;
  double? f;
  double? b;
    ...
    return Column(
      children: [
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
            labelText: 'อัตราสิ้นเปลืองไฟฟ้า(kWh/100km)',
            prefixIcon: Icon(Icons.timeline,color: Color.fromARGB(255, 85, 255, 0)),
          ),
          validator: Validators.multiValidator([
            Validators.required(errorMessage: 'กรุณากรอกอัตราสิ้นเปลืองไฟฟ้า'),
            Validators.numberValidator(errorMessage: 'กรอกเป็นตัวเลขเท่านั้น'),
            Validators.minValue(minValue: 0, errorMessage: "ค่าต้องไม่ติดลบ"),
          ]),
          onChanged: (value) {
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
            labelText: 'ราคาไฟฟ้า(บาท/kWh)',
            prefixIcon: Icon(Icons.local_gas_station ,color: Color.fromARGB(255, 255, 0, 0)),
          ),
          validator: Validators.multiValidator([
            Validators.required(errorMessage: 'กรุณากรอกราคาไฟฟ้า'),
            Validators.numberValidator(errorMessage: 'กรอกเป็นตัวเลขเท่านั้น'),
            Validators.minValue(minValue: 0, errorMessage: "ค่าต้องไม่ติดลบ"),
          ]),
          onChanged: (value) {
          ...
          children: [
            ElevatedButton.icon(
              ...
              onPressed: () {
                ...
                showMessagedialog(
                  "ผลการคำนวณ",
                  " ปริมาณพลังงานที่ต้องใช้= ${max.toStringAsFixed(2)} kWh\n"
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("เดินทางด้วยรถไฟฟ้า 🚄"),
        actions: [
          IconButton(
